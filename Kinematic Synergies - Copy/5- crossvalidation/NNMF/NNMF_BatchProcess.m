...
% Outcome will be a .mat file (NNMF_Y01.mat)

% 20151211 Written by Navid Shirzad
    ...
    for subjectcounter = 1:size(SubjectIDs,2)
        ...
        for fold = 1:NumberFolds
            ...
            while numSynergy < DOF 
                ...
                if GoodTrainR==0 & RightVAF(numSynergy,fold)>90 & DeltaRightVAF(numSynergy,fold)<5 & RightDOF_VAF(numSynergy,:,fold)>70 
                ...
                if GoodTrainL==0 & LeftVAF(numSynergy,fold)>90 & DeltaLeftVAF(numSynergy,fold)<5 & LeftDOF_VAF(numSynergy,:,fold)>70 
                ...
                if GoodTrainRVal==0 & ValRightVAF(numSynergy,fold)>90 & ValDeltaRightVAF(numSynergy,fold)<5 & ValRightDOF_VAF(numSynergy,:,fold)>70 
                ...
                if GoodTrainLVal==0 & ValLeftVAF(numSynergy,fold)>90 & ValDeltaLeftVAF(numSynergy,fold)<5 & ValLeftDOF_VAF(numSynergy,:,fold)>70 
...
%                     [coeff, bint, r, rint, stats] = regress(PCsLeftTrNorm(:,i), PCsRightTrNorm(:,j));
        ...
        %% save the analysis outcome
            ...
            save(strcat('NNMF_', 'Y', SubjID, '.mat' ), 'RightVAF', 'LeftVAF', ...
