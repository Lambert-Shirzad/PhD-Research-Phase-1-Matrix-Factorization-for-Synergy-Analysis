% to extract ICA performance summary data 
% Outcome will be several .mat files

% 20151213 Written by Navid Shirzad

function ICA_Summary_BatchProcess(SubjectIDs)
    ...
    for subjectcounter = 1:size(SubjectIDs,2)
        ...
        %% save the analysis outcome
            ...
            save(strcat('ICA_Performance_Summary', '.mat' ), ...
