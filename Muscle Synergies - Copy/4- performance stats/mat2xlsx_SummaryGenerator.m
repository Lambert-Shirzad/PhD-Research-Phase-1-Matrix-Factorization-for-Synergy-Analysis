...
function mat2xlsx_SummaryGenerator()
    ...
    load('PCA_Performance_Summary.mat'); %PCA_Performance_Summary_Weight.mat
...
%     OutputName = 'Factorization_Performance_Metrics_Healthy_Muscle_Synergies_Weight.xls';
...
%     figure()
%     boxplot([ndimAll(1:sizePCA-2,1), ndimAll(sizePCA+1:sizePCA*2-2,1), ...
%         ndimAll(sizePCA*2+1:sizePCA*2+sizeNNMF-2,1), ndimAll(sizePCA*2+sizeNNMF+1:sizePCA*2+sizeNNMF*2-2,1), ...
...
%     
%     figure()
%     boxplot([AvgReconsErrTrAll(1:sizePCA-2,1), AvgReconsErrTrAll(sizePCA+1:sizePCA*2-2,1), ...
%         AvgReconsErrTrAll(sizePCA*2+1:sizePCA*2+sizeNNMF-2,1), AvgReconsErrTrAll(sizePCA*2+sizeNNMF+1:sizePCA*2+sizeNNMF*2-2,1), ...
...
%     
%     figure()
%     boxplot([AvgReconsErrValAll(1:sizePCA-2,1), AvgReconsErrValAll(sizePCA+1:sizePCA*2-2,1), ...
%         AvgReconsErrValAll(sizePCA*2+1:sizePCA*2+sizeNNMF-2,1), AvgReconsErrValAll(sizePCA*2+sizeNNMF+1:sizePCA*2+sizeNNMF*2-2,1), ...
...
%     
%     figure()
%     boxplot([RegCoeffTrAll(1:sizePCA-2,1), RegCoeffTrAll(sizePCA+1:sizePCA*2-2,1), ...
%         RegCoeffTrAll(sizePCA*2+1:sizePCA*2+sizeNNMF-2,1), RegCoeffTrAll(sizePCA*2+sizeNNMF+1:sizePCA*2+sizeNNMF*2-2,1), ...
...
%     
%     figure()
%     boxplot([RegCoeffValAll(1:sizePCA-2,1), RegCoeffValAll(sizePCA+1:sizePCA*2-2,1), ...
%         RegCoeffValAll(sizePCA*2+1:sizePCA*2+sizeNNMF-2,1), RegCoeffValAll(sizePCA*2+sizeNNMF+1:sizePCA*2+sizeNNMF*2-2,1), ...
...
%             
%     figure()
%     boxplot(100*[nCommonAll(1:sizePCA-2,1), nCommonAll(sizePCA+1:sizePCA*2-2,1), ...
%         nCommonAll(sizePCA*2+1:sizePCA*2+sizeNNMF-2,1), nCommonAll(sizePCA*2+sizeNNMF+1:sizePCA*2+sizeNNMF*2-2,1), ...
...
%     
%     figure()
%     boxplot(100*[nCommonBothSidesAll(1:sizePCA-2,2), ...
%         nCommonBothSidesAll(sizePCA+1:sizePCA+sizeNNMF-2,2), ...
...
%     
%     figure()
%     boxplot([ElapsedTimeAll(1:sizePCA-2,1), ...
%         ElapsedTimeAll(sizePCA+1:sizePCA+sizeNNMF-2,1), ...
